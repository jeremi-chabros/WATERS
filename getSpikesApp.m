classdef getSpikesApp < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function [spikeTimes, spikeWaveforms, trace] = detect_spikes_cwt(...
            ...
            refPeriod = 2; % Only used by the initial threshold method
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.CostparametersEditField.Tooltip = 'List of cost parameters (separated by comma) in range [-0.2, 0.2]. For unsupervised detection recommended value is close to zero';
